...
function AppContent() {
  ...
  const { columns, cycle, direction } = useColumnCycle(isDesktop)
    ...
    <div className={styles.app} data-feed={selectedIndex !== null ? 'true' : 'false'} data-testid="app">
      ...
      {selectedIndex === null && (
        <CategoryBar
          ...
          onChange={(id) => {
            const next = id as Category
            if (activeCategoryBar === next) {
              setActiveCategoryBar(null)
              setActiveCategory('new')
            } else {
              setActiveCategoryBar(next)
      ...
      {selectedIndex === null && (
        <footer className={styles.footer} data-testid="grid-footer">
          ...
          <div className={styles.footerCredit}>
            <span className={styles.footerCreditText}>CREATED BY</span>
            <img src="/favicon.png" alt="AVIX" className={styles.footerLogo} />
          </div>
        </footer>
      )}
